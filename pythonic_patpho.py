class PatPho(object):
    ...
    def __init__(self, binary=True):
        ...
        if binary:
            ...
            self.phonemes = {"i": (0, 1, 0, 1, 1), "I": (0, 1, 0, 0, 1),
            ...
            self.phonemes = {"i": (0.100, 0.100, 0.100),
                             "I": (0.100, 0.100, 0.185),
                             "e": (0.100, 0.100, 0.270),
                             "E": (0.100, 0.100, 0.355),
                             "&": (0.100, 0.100, 0.444),
    ...
    def get_phon_vector(self, phonemes, left=True):
        ...
        starting from the left (left-justified format), which emphasizes
        similarities of word-vectors at the beginning; else,
        place phonemes on the grid going from right to left,
